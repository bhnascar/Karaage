$(function() {
  // Create a new CoherentAnimation for logo. By default it's always on pause
  ...
  var moveFromRight = {seconds: 1, right: -450, opacity: 0, ease: Circ.easeIn};
  var moveFromTop = {seconds: 1, top: -400, opacity: 0, ease: Circ.easeIn};
  var moveFromDown = {seconds: 1, top: 'auto', bottom: -300, opacity: 0,
                      ease: Circ.easeIn};
  ...
  // Array with objects definition for animations with percent definition
  var blink = [
  ...
  var rotation = {seconds: 2, rotationZ:360, ease:Power0.easeIn, repeat: -1};
  ...
  // If you use percents of your animation snippet, you need to set seconds in your method
